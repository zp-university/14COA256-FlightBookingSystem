...
void FlightManager::loadFlights() {
	...
	while (getline(file, line, '\n')) {
		...
		if (elements[0].length() != 3 || elements[1].length() != 3) {
			...
			cout << "The flight had an airport code that wasn't 3 characters long!" << endl;
			cout << "The line data was: " << line << endl;
			cout << "The line number was: " << flights.size() + 1 << endl;
			continue;
		}
...
void FlightManager::loadAirports() {
    ...
    while (getline(file, line, '\n')) {
		...
		if (elements[0].length() != 3) {
			...
			cout << "Airport had a code that wasn't 3 characters long!" << endl;
			cout << "The line data was: " << line << endl;
			cout << "The line number was: " << airports.size() + 1 << endl;
			continue;
		}
    ...
    cout << "Loaded " << airports.size() << " airports." << endl << endl;
}
